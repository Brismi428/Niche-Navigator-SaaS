...
export const APP_CONFIG = {
  ...
  email: 'hello@nichenavigator.com',
  social: {
    github: 'https://github.com/nichenavigator',
    twitter: 'https://twitter.com/nichenavigator',
    linkedin: 'https://linkedin.com/company/nichenavigator',
  },
} as const;

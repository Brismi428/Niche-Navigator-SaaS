            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                <div
                  ...
                  className="min-h-[400px] max-h-[600px] overflow-y-auto overflow-x-hidden p-6 border rounded-md bg-background prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold"

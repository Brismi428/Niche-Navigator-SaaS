# Niche Navigator - Installation Guide for macOS

This comprehensive installation guide will help you set up Niche Navigator with complete Supabase authentication, Stripe payments, and all necessary integrations. This guide is optimized for use with **Claude Code** and its MCPs (Model Context Protocols) to automate most of the setup process.
...
git clone https://github.com/your-username/niche-navigator.git
cd niche-navigator
